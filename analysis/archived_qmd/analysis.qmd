...
dw_national_quartiles %>% write.csv("data_input/data_edit/dw_national_quartiles.csv")
```
...
### DW 10 cities agregated data - Exploration 2 threshold
...
### DW ~~Lollipop~~ chart agregated 10 cities - bar chart with lowest and highest & difference  - Exploration 
...
### DW Template scatterplot - one per cities  - Exploration small multiple
